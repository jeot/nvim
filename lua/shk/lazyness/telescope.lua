local function config()
	...
	vim.keymap.set('n', '<leader>fW', function() builtin.grep_string({ search = vim.fn.expand("<cWORD>") }) end, { desc = 'Find Current Word' })
	...
	vim.keymap.set('n', '<leader>fa', function() builtin.find_files({ no_ignore = true, no_ignore_parent = true, hidden = true, }) end, { desc = 'Find All Files' })
